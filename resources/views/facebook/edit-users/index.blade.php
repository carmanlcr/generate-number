...
@section('content')
	...
	<div class="card">
		...
		<div class="card-body">
			<form action="{{ route('updateFacebookUser', $usuario->users_id) }}" method="POST">
        			@csrf
		        	...
		        	<div class="row form-group">
		                ...
		                <div class="col-md-9">
							<div class="form-check">
								@if(count($usuario->users_block) > 0)

									<input type="checkbox" name="users_block_id" class="form-check-input" checked="checked">	
								@else
									<input type="checkbox" name="users_block_id" class="form-check-input">	
								@endif
							</div>
